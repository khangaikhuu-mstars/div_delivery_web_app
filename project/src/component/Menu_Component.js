      ...
      <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }}>
        ...
        <div className="info">
          <div className="menu-info">
            ...
            <Nav.Link className="tses-toggle" href="#">Хоолны цэс</Nav.Link>
            <a href=""><img src={see} alt="" /></a>
          </div>
          ...
          <div className="menu-info">
            ...
            <Nav.Link className="tses-toggle" href="#">Хүргэлтийн бүс</Nav.Link>
            <a href=""><img src={see} alt="" /></a>
          </div>
        </div>

        {/* Mobile Version Toggle User Info*/}
        <div className="user">
          <div className="menu-info">
            <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="35" height="35" rx="10" fill="#F2994A" fill-opacity="0.1" />
            ...
            <Nav.Link className="tses-toggle" href="#">Хэрэглэгчийн мэдээлэл</Nav.Link>
            <a href=""><img src={see} alt="" /></a>
          </div>
          <div className="line"></div>
          <div className="menu-info">
            ...
            <Nav.Link className="tses-toggle" href="#">Миний захиалга</Nav.Link>
            <a href=""><img src={see} alt="" /></a>
          </div>
        </div>
      ...
      <Form className="d-flex form">
        ...
        <div className="loginBusket">
          ...
          <div className="busket">
            <a href=""><img src={busket} alt="" /></a>
            <Button variant="outline-none" className="sags">Сагс</Button>
          </div>
          <div className="login">
            <a href=""><img src={human} alt="" /></a>
            <Button variant="outline-none" className="signin">Нэвтрэх</Button>
          </div>
        </div>
      </Form>
