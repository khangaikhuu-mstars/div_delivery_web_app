      ...
      <fieldset enabled>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Select className="formSize" id="enabledSelect">
            ...
            <option value={1} className="backColor1">Баянзүрх дүүрэг</option>
            <option value={2} className="backColor1">Хан-Уул дүүрэг</option>
            <option value={3} className="backColor1">Сонгино-Хайрхан дүүрэг</option>
            <option value={4} className="backColor1">Чингэлтэй дүүрэг</option>
            <option value={5} className="backColor1">Сүхбаатар дүүрэг</option>
          </Form.Select>
        </Form.Group>
        <Form.Group className="mb-3">
          <InputGroup className="mb-1">
        ...
        <Form.Label htmlFor="enabledSelect" className="textColor">Хаягын дэлгэрэнгүй</Form.Label>
        ...
        <Form.Label htmlFor="enabledSelect" className="textColor">Утасны дугаар</Form.Label>
        ...
        <Form.Label htmlFor="enabledSelect" className="textColor">Төлбөр төлөх</Form.Label>
