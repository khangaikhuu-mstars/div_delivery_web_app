            ...
            <Form>
                ...
                <Form.Group className="mb-2">
                    <InputGroup className="mb-2" >
                        ...
                        <InputGroup.Text className="leftIcons userBack"><img src="/icons/user.svg" alt="" /></InputGroup.Text>
                ...
                <Form.Group className="mb-2 "  >
                    <InputGroup className="mb-2" >
                        ...
                        <InputGroup.Text className="leftIcons userBack"><img src="/icons/phone.svg" alt="" /></InputGroup.Text>
                        <InputGroup.Text className="rightIcons"></InputGroup.Text>
                    </InputGroup>
                </Form.Group>
