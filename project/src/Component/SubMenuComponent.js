...
<div>
    <Container>
        <Nav justify id="menu-tab" variant="pills" className="text-center mt-4" defaultActiveKey="/main">
            <Nav.Item className="me-2">
                <NavLink className="nav-link" to={`${match.url}/main`}> Үндсэн хоол </NavLink>{" "}
          </Nav.Item>{" "}
          <Nav.Item className=" mx-2">
                    <NavLink className="nav-link" to={`${match.url}/salad`}> Салад ба зууш </NavLink>{" "}
          </Nav.Item>
          <Nav.Item className=" mx-2">
                        <NavLink className="nav-link" to={`${match.url}/dessert`}> Амттан </NavLink> </Nav.Item>
                            <Nav.Item className="ms-2">
                            <NavLink className="nav-link" to={`${match.url}/sales`}> Хямдралтай </NavLink> </Nav.Item>
